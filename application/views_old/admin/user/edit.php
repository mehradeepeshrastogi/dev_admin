 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i><?php echo trans('edit_user');?></a></li>
      </ol>
    </section>
               ...
               <div class="col-md-9">   
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name" value="<?php echo !empty($user->name)?$user->name:''; ?>" placeholder="<?php echo trans('name');?>">
                        </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="user_name" value="<?php echo !empty($user->user_name)?$user->user_name:''; ?>" placeholder="<?php echo trans('user_name');?>">
                        </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="phone" value="<?php echo !empty($user->phone)?$user->phone:''; ?>" placeholder="<?php echo trans('phone');?>">
                        </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="email" class="form-control" name="email" value="<?php echo !empty($user->email)?$user->email:''; ?>" placeholder="<?php echo trans('email');?>">
                        </div>
                  </div>
                  ...
                  <div class="col-md-6">
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="password" value="" placeholder="<?php echo trans('password');?>">
                        </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="active">
                            ...
                            <option value="0" <?php echo ($user->active == 0)?'selected':'';?>><?php echo trans('inactive');?></option> 
                        </select>
                      </div>
                  </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group">
                            <label for="<?php echo trans('user_profile_image');?>"><?php echo trans('user_profile_image');?></label>
                              <img src="<?php echo !empty($user->profile_image) ? base_url('uploads/user/').$user->profile_image:$defaultImage; ?>" class="img img-thumbnail defaultImage" id="previewImage"/>
