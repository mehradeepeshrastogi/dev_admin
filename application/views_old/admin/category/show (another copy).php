...
<div class="col-md-12">
  <table class="table table-striped">
    <tr>
              <?php foreach($category[0]->categoryImage as $k=>$ci){
                  if($k%4 == 0){
                    echo "</tr><tr>";
                  }
                ?>
                <td>
                        ...
                        <?php } ?>
                            ...
                            <?php
                              foreach($ci->categoryImage_name as $ci_image){ ?>
                                  
                                  <tr>
                                      <td class='text-center' title="<?php echo trans($languages[$ci_image->lang_id-1]->name).'('.trans('image_caption').')';?>">
                                           <?php echo $ci_image->name;?>
                                    </td>
                                </tr>
                            <?php } ?>
