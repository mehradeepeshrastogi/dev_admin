 ...
 <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1><?php echo trans('edit_page');?></h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i><?php echo trans('edit_page');?></a></li>
      </ol>
    </section>
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
              ...
              <div class="box-header with-border">
                  <div class="col-sm-6">
                      <h3 class="box-title"><?php echo trans('edit_page');?></h3>
                  </div>
                  ...
                  <div class="col-md-10">
                    <div class="form-group">
                        ...
                        <?php foreach($languages as $k=>$language): ?>
                            <input type="text" class="form-control" name="name[<?php echo $language->lang_id;?>]" value="<?php echo $page[$k]->name;?>" placeholder="<?php echo trans('page_name');?>">
                        <?php endforeach; ?>
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <label for="<?php echo trans('slug');?>"><?php echo trans('slug');?></label>
                          <input type="text" class="form-control" name="slug" value="<?php echo $page[0]->slug;?>" placeholder="<?php echo trans('slug');?>">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        <label for="<?php echo trans('short_order');?>"><?php echo trans('short_order');?></label>
                          <input type="number" min="0" class="form-control" name="short_order" value="<?php echo $page[0]->short_order;?>" placeholder="<?php echo trans('short_order');?>">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="active">
                              <option value="1" <?php echo ($page[0]->active==1)?'selected':'';?> >
                                <?php echo trans('active');?>
                              </option>
                              <option value="0" <?php echo ($page[0]->active==0)?'selected':'';?>><?php echo trans('inactive');?></option> 
                        </select>
                      </div>
                  </div>
              ...
              <!-- /.box-body -->
                  ...
                  <?php foreach($languages as $k=>$language): ?>
                    <div class="col-md-12" style="margin-left:-15px;<?php echo ($k>0)?'margin-top:50px':'';?>" >
                        ...
                        <div class="col-md-10">
                            <textarea type="text" class="form-control" id="description_<?php echo $language->lang_id;?>" name="description[<?php echo $language->lang_id;?>]" placeholder="<?php echo trans('page_description');?>"><?php echo $page[$k]->description;?></textarea>
                        </div>
                    </div>
                  <?php endforeach; ?>
