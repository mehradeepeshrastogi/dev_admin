                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        <label for="<?php echo trans('category_name');?>"><?php echo trans('category_name');?></label>
                            ...
                            <input type="text" class="form-control" name="name" value="<?php echo $category->name; ?>" placeholder="<?php echo trans('category_name');?>">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select class="form-control" name="lang_id">
                            <option value="1" <?php echo ($category->lang_id==1)?'selected':'';?> >
                              <?php echo trans('active');?>
                            </option>
                            <option value="0" <?php echo ($category->lang_id==0)?'selected':'';?>><?php echo trans('inactive');?></option> 
                        </select>
                      </div>
                  </div>
                    ...
                    <div class="col-md-12">
                        <label for="<?php echo trans('description');?>"><?php echo trans('description');?></label>
                            <textarea type="text" class="form-control" id="description" name="description" placeholder="<?php echo trans('category_description');?>"><?php echo $category->description; ?></textarea>
                    </div>
