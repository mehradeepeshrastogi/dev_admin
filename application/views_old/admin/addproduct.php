            ...
            <div class="box-body">
				<div class="col-md-6">
					<div class="form-group">
					  ...
					  <select class="form-control categoryGroup" name="id_category[]" multiple >
							<?php 
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea class="description" id="description_short" name="editor1" rows="10" cols="80" placeholder="Description">
				...
				<div class="col-md-12">
					<div class="form-group">
						...
						<textarea class="description" id="description" name="editor1" rows="10" cols="80" placeholder="Description">
							This is my textarea to be replaced with CKEditor.
						</textarea>
					</div>
				</div>   
